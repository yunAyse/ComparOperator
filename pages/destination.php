          ...
          <div class="d-flex flex-wrap justify-content-evenly gap-4 pt-5">
            ...
            <?php foreach ($destinationsByLocation as $destinationByLocation) { ?>
              <div class="card" style="width: 18rem;">
                ...
                <div class="card-body">
                  <h5 class="card-title fs-4"><?php echo $destinationByLocation['location'] ?></h5>
                  <div class="d-flex justify-content-between">
                    <p class="card-text"><?php foreach ($OperatorsByLocation as $operator) {
                                            // var_dump($operator);
                                            echo $operator['name'];
                                          } ?></p>
                    <p class="card-text fw-bold"><?php echo $destinationByLocation['price'] ?>$</p>
                  </div>
                  <form action="./the-destination.php" method="post">
